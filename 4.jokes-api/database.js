...
export async function getCategoryId(db, category) {
...
export async function getJoke(db, joke_id) {
    return new Promise((resolve, reject) => {
...
export async function getRandomJoke(db) {
    return new Promise((resolve, reject) => {
...
export async function getRandomJokeByCategory(db, category_name) {
    try {
...
export async function getJokesByCategory(db, category_name) {
    try {
        const id_category = await getCategoryId(db, category_name)
...
export async function addCategory(db, category_name) {
    return new Promise((resolve, reject) => {
...
export async function addNewJokeToCategory(db, joke_content, category_name) {
    try {
...
export async function addJokeToCategory(db, joke_id, category_id) {
    return new Promise((resolve, reject) => {
...
export async function likeJoke(db, joke_id) {
    return new Promise((resolve, reject) => {
...
export async function dislikeJoke(db, joke_id) {
    return new Promise((resolve, reject) => {
